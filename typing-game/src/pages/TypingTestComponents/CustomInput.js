...
import ViewTexts from "./ViewTexts"; // ✅ Import your separate ViewTexts component
...
const CustomInput = ({ selectedCustom, setSelectedCustom }) => {
  ...
  const { setDisplayedWords, selectedOption ,displayedWords, showTexts, setShowTexts} = useContext(GetValuesContext);
